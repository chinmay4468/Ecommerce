...
const Banner = () => {
  // State to control the visibility of the banner and promo code
  ...
  const generatePromoCode = () => {
    const codes = ['SUMMER20', 'SAVE15', 'DISCOUNT10', 'FREESHIP', 'EXTRA5'];
  ...
  return (
    isVisible && (
      <div className="flex items-center max-md:flex-col gap-6 bg-gradient-to-tr from-blue-700 to-purple-400 text-white px-6 py-3.5 rounded font-[sans-serif]">
        ...
        <div>
          {promoCode ? (
            <span className="bg-white text-blue-500 py-2.5 px-5 rounded text-sm">
